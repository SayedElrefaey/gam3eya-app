...
void _addIndividualInvoicePage({
  ...
  final tableRows = <pw.TableRow>[
    pw.TableRow(
      ...
      children: [
        _cell('الرصيد', bold, latinFallback, center: true, fontSize: 16, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 8),
        _cell('له', bold, latinFallback, center: true, fontSize: 16, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 8),
        _cell('عليه', bold, latinFallback, center: true, fontSize: 16, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 8),
        _cell('التفاصيل', bold, latinFallback, center: true, fontSize: 16, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 8),
        _cell('التاريخ', bold, latinFallback, center: true, fontSize: 16, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 8),
      ],
    ),
    ...rows.map((r) => pw.TableRow(children: [
      _cell(fmtNum(r.balance), bold, latinFallback, center: true, fontSize: 16, textColor: const PdfColor.fromInt(0xFFA3002B), padding: 8),
    ...
    pw.TableRow(
      ...
      children: [
        ...
        _cell(fmtNum(totalCredit), bold, latinFallback, center: true, fontSize: 16, textColor: const PdfColor.fromInt(0xFF1E8A3C), padding: 8),
    ...
    pw.TableRow(
      ...
      children: [
        ...
        _cell('', bold, latinFallback, center: true, fontSize: 18, padding: 9),
        _cell(finalBalance >= 0 ? 'الرصيد الإجمالي - عليه' : 'الرصيد الإجمالي - له', bold, latinFallback, center: true, fontSize: 20, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
        _cell('', bold, latinFallback, center: true, fontSize: 18, padding: 9),
      ],
    ),
  ];
