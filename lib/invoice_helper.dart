...
void _addIndividualInvoicePage({
  ...
  final tableRows = <pw.TableRow>[
    pw.TableRow(
      ...
      children: [
        _cell('الرصيد', bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
        _cell('له', bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
        _cell('عليه', bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
        _cell('التفاصيل', bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
        _cell('التاريخ', bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
      ],
    ),
    ...rows.map((r) => pw.TableRow(children: [
      _cell(fmtNum(r.balance), bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFFA3002B), padding: 9),
      _cell(r.credit == 0 ? '0' : fmtNum(r.credit), bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1E8A3C), padding: 9),
      _cell(r.debit == 0 ? '0' : fmtNum(r.debit), bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFFA3002B), padding: 9),
      _cell(r.details, bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
      _cell(r.date, bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 9),
    ])),
    pw.TableRow(
      decoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFFEDEDED)),
      children: [
        _cell('', bold, latinFallback, center: true, fontSize: 17, padding: 9),
        _cell(fmtNum(totalCredit), bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFF1E8A3C), padding: 9),
        _cell(fmtNum(totalDebit), bold, latinFallback, center: true, fontSize: 17, textColor: const PdfColor.fromInt(0xFFA3002B), padding: 9),
        _cell('إجمالي العمليات', bold, latinFallback, center: true, fontSize: 17, padding: 9),
        _cell('', bold, latinFallback, center: true, fontSize: 17, padding: 9),
      ],
    ),
    pw.TableRow(
      ...
      children: [
        _cell('${fmtNum(finalBalance.abs())} $currency'.trim(), bold, latinFallback, center: true, fontSize: 21, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 10),
        _cell('', bold, latinFallback, center: true, fontSize: 19, padding: 10),
        _cell('', bold, latinFallback, center: true, fontSize: 19, padding: 10),
        _cell(finalBalance >= 0 ? 'الرصيد الإجمالي - عليه' : 'الرصيد الإجمالي - له', bold, latinFallback, center: true, fontSize: 21, textColor: const PdfColor.fromInt(0xFF1414A0), padding: 10),
        _cell('', bold, latinFallback, center: true, fontSize: 19, padding: 10),
      ],
    ),
  ];
  ...
  doc.addPage(pw.Page(
    ...
    build: (context) => pw.Column(
      ...
      children: [
        pw.Text(title, textAlign: pw.TextAlign.center, textDirection: pw.TextDirection.rtl, style: pw.TextStyle(font: headingBold, fontSize: 20, fontFallback: [latinFallback])),
        pw.SizedBox(height: 2),
        pw.Text(subtitle, textAlign: pw.TextAlign.center, textDirection: _directionForText(subtitle), style: pw.TextStyle(font: bold, fontSize: 12, fontFallback: [latinFallback], color: const PdfColor.fromInt(0xFF6B6248))),
