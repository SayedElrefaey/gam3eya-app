...
class ScheduleItem {
  ...
  ScheduleItem({required this.id, required this.monthIdx, required this.dueDate, required this.amount, required this.paid});
...
class Gam3eya {
  ...
  double get paidTotal => schedule.where((s) => s.paid).fold(0.0, (a, s) => a + s.amount);
